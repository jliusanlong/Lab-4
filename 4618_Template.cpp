...
void lab3()
{
    ...
    do
    {
        ...
        case 'a':
            do 
            {
				...
				std::cout << "ANALOG TEST: CH26 X = " << X_value << " (" 
                          << std::fixed << std::setprecision(1) << X_percentage << " %)";
                std::cout << " CH2 Y = " << Y_value << " (" 
                          << std::fixed << std::setprecision(1) << Y_percetnage << " %)\n";
				Sleep(1);
        ...
        case 'd':
            do
            {
               control.get_data(DIGITAL, 33, value);
                
                if (value == 0)
                {
                  control.set_data(DIGITAL, 39, 1);
            
                }
                else
                {
                    control.set_data(DIGITAL, 39, 0);
           
               }
                
               std::cout << "Digital Read 33: " << value << "\n";
              Sleep(1);
        ...
        case 's':
            while (true)
            {
                ...
                {
                    control.set_data(SERVO, 0, position);
